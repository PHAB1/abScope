...
ig_db_path="/home/glicina/pbarros/abScope/references/database/human/ig_db/"
...
for file in $1/*.fasta; do
    ...
    igblastn -germline_db_J "$ig_db_path/IGHLKJ_edit.fasta" -germline_db_V "$ig_db_path/IGHLKV_edit.fasta" -germline_db_D "$ig_db_path/IGHD_edit.fasta" -query "$file" -outfmt 19 -show_translation -auxiliary_data "$ig_db_path"/human_gl.aux -num_threads 12 -out "$2/$prefix$filename_no_ext.tsv" -domain_system kabat
